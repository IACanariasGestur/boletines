...
Original file is located at
    https://colab.research.google.com/drive/1rfjz-saVzo0ixtwwzPYb1oYH9GHjacCj
"""
...
st.title("📄 Buscador de Boletines Oficiales (Canarias + BOE)")
...
if st.button("🔍 Buscar boletines relevantes"):
    ...
    if documentos:
        ...
        st.success(f"✅ {len(df)} documento(s) encontrados.")
        st.dataframe(df)

        csv = df.to_csv(index=False, encoding="utf-8-sig")
        st.download_button("📥 Descargar CSV", csv, "boletines.csv", "text/csv")
    else:
        st.warning("📭 No se encontraron publicaciones relevantes.")